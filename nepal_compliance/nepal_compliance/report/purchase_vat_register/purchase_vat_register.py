    ...
    for purchase in purchase_invoice:
        ...
        for t in tax:
            if t.rate == 13:
                ...
                tds += t.tax_amount
        data.append([purchase.nepali_date, purchase.name, purchase.supplier, purchase.bill_no, purchase.tax_id, total_qty, purchase.total, purchase.discount_amount, gross_amount, net_total, item.warehouse, vat, tds, invoice_total, purchase.outstanding_amount, purchase.total_taxes_and_charges])

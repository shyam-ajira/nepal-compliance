	...
	for sale in sales_invoice:
		...
		for tax in taxes:
			if tax.rate == 13:
				...
				tds = tax.tax_amount
		data.append([sale.nepali_date, sale.name, sale.customer, sale.customer_group, sale.project, sale.cost_center, sale.tax_id, sale.owner, total_qty, sale.total,sale.discount_amount, sale.total, net_total, vat, tds, sale.total_taxes_and_charges, sale.total_advance, sale.grand_total, sale.rounded_total, sale.outstanding_amount, sale.return_against])
	return columns, data

...
def execute(filters=None):
    ...
    sales_invoices_query = f"""
        SELECT si.name AS invoice_no, si.nepali_date, si.customer AS customer, si.tax_id AS tax_id, si.rounded_total AS sales_amount, 
    ...
    purchase_invoices_query = f"""
        SELECT pi.name AS invoice_no, pi.nepali_date, pi.supplier AS supplier, pi.tax_id AS tax_id, pi.grand_total AS purchase_amount, 
